...
_ _ _
### [The Audio Auditor: User-Level Membership Inference with Black-Box Access](auditor_black-box.md)
<p>Abstract:</p>
...
_ _ _
### [The Audio Auditor: Label-Only User-Level Membership Inference in Internet of Things Voice Services](auditor_label-only.md)
<p>Abstract:</p>
...
_ _ _
### [The Audio Auditor: No-Label User-Level Membership Inference in Internet of Things Voice Services](auditor_no-label.md)
<p>Abstract:</p> 
...
_ _ _
### [FAAG: Fast Adversarial Audio Generation through Interactive Attack Optimisation](FAAG.md)
<p>Abstract: </p>
