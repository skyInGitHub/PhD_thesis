...
#### Stealing controlled user activities information ([link](https://github.com/skyInGitHub/Machine-Learning-Based-Cyber-Attacks-Targeting-on-Controlled-Information-A-Survey/blob/master/user_activities.md))
...
#### Stealing controlled ML model related information ([link](https://github.com/skyInGitHub/Machine-Learning-Based-Cyber-Attacks-Targeting-on-Controlled-Information-A-Survey/blob/master/ml_model_related.md))
...
#### Stealing controlled authentication inforamtion ([link](https://github.com/skyInGitHub/Machine-Learning-Based-Cyber-Attacks-Targeting-on-Controlled-Information-A-Survey/blob/master/authentication.md))
...
_ _ _
### The Audio Auditor: User-Level Membership Inference with Black-Box Access
<p>Abstract:</p> [auditor_black-box.md]
...
_ _ _
### The Audio Auditor: Label-Only User-Level Membership Inference in Internet of Things Voice Services
<p>Abstract:</p> [auditor_label-only.md]
...
_ _ _
### The Audio Auditor: No-Label User-Level Membership Inference in Internet of Things Voice Services
<p>Abstract:</p> [auditor_no-label.md]
